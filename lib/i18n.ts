...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'stats.achievements.focusStarter.description': 'Complete 5 work sessions.',
    'stats.achievements.breakChampion.name': 'BREAK CHAMPION',
    'stats.achievements.breakChampion.description': 'Log 15 breaks of any type.',
    ...
    'stats.achievements.comboBreaker.description': 'Reach the score streak goal for your difficulty.',
    ...
    'settings.achievementDifficulty': 'Achievement difficulty',
    'settings.difficulty.easy': 'Generous thresholds and shorter streaks to ease into the habit.',
    'settings.difficulty.normal': 'Balanced requirements aligned with classic Pomodoro pacing.',
    'settings.difficulty.hard': 'Ambitious goals demanding long streaks and high combo scores.',
    'settings.resetStats': 'Reset stats',
    'settings.resetStatsHint': 'Clears all sessions and achievements but keeps your difficulty.',
    'settings.resetStatsConfirm': 'This will erase all recorded sessions and achievements. Continue?',
    'settings.resetStatsConfirmButton': 'Reset',
  ...
  tr: {
    ...
    'stats.difficulty': 'ZORLUK',
    'stats.unlocked': 'ACILDI',
    'stats.achievements.focusStarter.name': 'ODAK BASLANGIC',
    'stats.achievements.focusStarter.description': '5 calisma oturumu tamamla.',
    'stats.achievements.breakChampion.name': 'MOLA USTASI',
    'stats.achievements.breakChampion.description': 'Her turdan 15 mola kaydet.',
    ...
    'stats.achievements.comboBreaker.description': 'Zorluk hedefindeki puan serisine ulas.',
    ...
    'settings.achievementDifficulty': 'Basari zorlugu',
    'settings.difficulty.easy': 'Baslangic icin esnek hedefler ve kisa seriler.',
    'settings.difficulty.normal': 'Klasik Pomodoro ritmine yakin dengeli gereksinimler.',
    'settings.difficulty.hard': 'Uzun seriler ve yuksek puan kombosu isteyen zorlu hedefler.',
    'settings.resetStats': 'Istatistikleri sifirla',
    'settings.resetStatsHint': 'Tum oturum ve basarilari siler, zorlugu korur.',
    'settings.resetStatsConfirm': 'Tum oturumlar ve basarilar silinecek. Devam edilsin mi?',
    'settings.resetStatsConfirmButton': 'Sifirla',
